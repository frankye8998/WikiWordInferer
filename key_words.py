...
while len(key_words) != 20:
	try:
		...
		typeofword = "False"
	if typeofword in ["preposition", "interjection", "conjunction", "False", "verb", "pronoun", "the","of","and","a","to","in","is","you","that","it","he","was","for","on","are","as","with","his","they","I","at","be","this","have","from","or","one"]:
		word_testing = randint(0,len(list_of_words))
	else:
